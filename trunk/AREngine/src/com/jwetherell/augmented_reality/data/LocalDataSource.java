...
public class LocalDataSource extends DataSource{
    private static List<Marker> cachedMarkers = new ArrayList<Marker>();
    ...
    public void setMarkers(double lat, double lng, String title) {
    	    	
                Marker temp = new Marker(title, lat, lng,0, Color.YELLOW);
    ...
    public List<Marker> getMarkers() {
        Marker atl = new IconMarker("ATL", 37.7238133, -122.479809, 0, Color.DKGRAY, icon);
